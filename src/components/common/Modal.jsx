...
const Modal = ({ children, width, show, onHide, title, force }) => {
      ...
      {show && (
        <motion.div
          ...
          className={`fixed inset-0 ${
            force ? "z-[110]" : "z-[100]"
          } bg-gray-800 bg-opacity-50 backdrop-blur-[2px] justify-center items-center`}
          dir="rtl"
        ...
        >
          <div
            className={`${
              width ? width : "w-[95%] sm:w-[400px] md:w-[500px] lg:w-[600px]"
          ...
          >
            <div className="w-full flex justify-between items-center p-3 rounded-t-[16px] border-b border-gray-300">
              <div className="w-[calc(100%-30px)] font-theme-bold text-gray-800 select-none">
                {title ? title : ""}
              </div>
              <button
            ...
            <div className="p-3 min-h-[calc(20dvh)]  max-h-[calc(85dvh)] overflow-y-auto">
              {children}
            </div>
          </div>
        </motion.div>
